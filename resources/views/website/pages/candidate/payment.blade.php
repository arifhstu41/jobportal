            ...
            <div class="row mx-auto">
                ...
                <div class="col-sm-10 col-md-8 mx-auto my-2">
                    <div class="card bg-primary-900 text-white text-bold text-center">
                        <div class="card-body">
                            <p>
                                ওয়েলফেয়ার ফ্যামিলি বাংলাদেশ এবং বেসরকারি উন্নয়ন সংস্থা (NGO) এবং কোম্পানির যৌথ উদ্যোগে
                                ...
                                বাস্তবায়নের জন্য "সামাজিক ও অর্থনৈতিকক্ষেত্রে টেকসই উন্নয়নের প্রয়াস"
                            </p>
                        </div>
                    </div>
                </div>
