            ...
            <div class="row mx-auto">
                ...
                <div class="col-sm-10 col-md-8 mx-auto my-2">
                    <div class="card bg-primary-900 text-white text-bold text-center">
                        <div class="card-body">
                            <p>
                                ওয়েলফেয়ার ফ্যামিলি বাংলাদেশ ও বেসরকারি উন্নয়ন সংস্থা (NGO) এবং কোম্পানির যৌথ উদ্যোগে (বাংলাদেশ গেজেটে প্রকাশিত বিজ্ঞপ্তির আলোকে) 'সাসটেইনেবল ডেভেলপমেন্ট পলিসি' (SDP) ও সোস্যাল অ্যান্ড ইকোনমিক ডেভেলপমেন্ট পলিসি' (SEDP) এবং পভার্টি এলিভিয়েশন পলিসি (Muldhan) প্রজেক্ট-প্রোগ্রাম বাস্তবায়নের জন্য "সামাজিক ও অর্থনৈতিকক্ষেত্রে টেকসই উন্নয়নের প্রয়াস"
                            </p>
                        </div>
                    </div>
                </div>
