                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 tw-mt-3">
                                    <div class="tw-flex tw-justify-center">
                                        <a href="{{ route('website.careerjet.job', ['keyword' => request('keyword'), 'category' => request('category')]) }}" class="btn btn-primary tw-inline-block">
                                           {{ __('view_more_jobs') }}
                                        </a>
                                    </div>
                                </div>
                    ...
                    @if (isset($indeed_jobs) && isset($indeed_jobs->results) && count($indeed_jobs->results))
                        <div class="col-12 mt-3 pt-3">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <div>
                                    <span>
                                        <a href="https://www.indeed.co.in">{{ __('jobs_by') }} <img alt="Indeed" src="https://www.indeed.com/p/jobsearch.gif"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 tw-mt-3">
                                    <div class="tw-flex tw-justify-center">
                                        <a href="{{ route('website.indeed.job', ['keyword' => request('keyword'), 'category' => request('category')]) }}" class="btn btn-primary tw-inline-block">
                                           {{ __('view_more_jobs') }}
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-transparent">
                    <h5 class="modal-title" id="cvModalLabel">{{ __('apply_job') }}: <span id="apply_job_title">{{ __('job_title') }}</span></h5>
