    ...
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="dashboard-right tw-mt-4 lg:tw-mt-0">
                                                ...
                                                @forelse($socials as $social)
                                                    <div class="col-12 custom-select-padding">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2">
                                                                <button class="btn tw-bg-[#F1F2F4] tw-p-4" type="button"
                                                                    id="remove_item">
        ...
        function add_features_field() {
            ...
            <div class="col-12 custom-select-padding">
                <div class="d-flex">
                    ...
                    <div class="ms-2">
                        <button class="btn tw-bg-[#F1F2F4] tw-p-4" type="button" id="remove_item">
