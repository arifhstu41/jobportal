                                        ...
                                        <div class="iconbox-content">
                                            <div class="">
                                                <a href="{{ route('website.employe.details', $company->user->username) }}"
                                                    class="tw-text-[#191F33] tw-text-lg tw-font-medium tw-whitespace-nowrap tw-text-ellipsis tw-overflow-hidden tw-inline-block tw-max-w-[150px] xs:tw-max-w-[250px]">{{ $company->user->name }}</a>
                                            </div>
