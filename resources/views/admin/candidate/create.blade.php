                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="skills" name="skills[]" class="select2-taggable form-control @error('skills') is-invalid @enderror" multiple>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="languages" name="languages[]" multiple class="select2bs4 form-control @error('languages') is-invalid @enderror">
